...
3. Start a Prometheus container
    ...
    Click "Status" -> "Configuration" to check whether the configuration file used by the container is correct:
     ...
     ![image](https://github.com/alexozerov/documentation-en/master/images/metrics_config.png)

     Click "Status" -> "Targets" to view the status of each monitored java-orgon node:

     ![image](https://github.com/alexozerov/documentation-en/master/images/metrics_targets.png)
...
3. Log in to the Grafana web UI
    ...
    ![image](https://github.com/alexozerov/documentation-en/master/images/metrics_datasource.png)

    Enter the ip and port of the prometheus service in `URL`:

    ![image](https://github.com/alexozerov/documentation-en/master/images/metrics_prometheus.png)
...
4. Import Dashboard
    ...
    ![image](https://github.com/alexozerov/documentation-en/master/images/metrics_import.png)
    ...
    ![image](https://github.com/alexozerov/documentation-en/master/images/metrics_dashboard.png)
