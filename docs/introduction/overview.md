...
![image](https://github.com/alexozerov/documentation-en/master/images/network.png)
...
```
 ...
 ![image](https://github.com/alexozerov/documentation-en/master/images/localwitness.jpg)
 witnesses:

 ![image](https://github.com/alexozerov/documentation-en/master/images/witness.png)
 version:

 ![image](https://github.com/alexozerov/documentation-en/master/images/p2p_version.png)
 enable:

 ![image](https://github.com/alexozerov/documentation-en/master/images/discovery_enable.png)
...
```
 ...
 ![image](https://github.com/alexozerov/documentation-en/master/images/ip_list.png)
 p2p.version:

 ![image](https://github.com/alexozerov/documentation-en/master/images/p2p_version.png)
 genesis.block:

 ![image](https://github.com/alexozerov/documentation-en/master/images/genesis_block.png)
 needSyncCheck:

 ![image](https://github.com/alexozerov/documentation-en/master/images/need_sync_check.png)
...
**4.7.1.1 Configuration**
 ...
 ![image](https://github.com/alexozerov/documentation-en/master/images/db_engine.png)
 Note: rocksdb only support db.version=2, do not support db.version=1

 The optimization parameters rocksdb support:
 ![image](https://github.com/alexozerov/documentation-en/master/images/rocksdb_tuning_parameters.png)
...
**4.7.1.2 Use rocksdb's data backup function**
 ...
 ![image](https://github.com/alexozerov/documentation-en/master/images/db_backup.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/bandwidthRestoreEqn.gif)
