...
![image](https://github.com/alexozerov/documentation-en/master/images/demo_codestyle_error.png)
Fix the code style warning in the picture, and then check the file again until there is no warning.
![image](https://github.com/alexozerov/documentation-en/master/images/demo_codestyle.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/javaorgon_pr.png)
